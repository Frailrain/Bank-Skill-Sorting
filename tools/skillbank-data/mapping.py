...
_TREASURE_TRAIL_MELEE_NAMES = [
    ...
    # session 64 — Group Ironman + Halloween 2021 stained + Torva (not smithable)
    "Group ironman platebody", "Group ironman platelegs",
    "Hardcore group ironman platebody", "Hardcore group ironman platelegs",
    "Pink stained platebody", "Pink stained platelegs", "Pink stained full helm",
    ...
    sections=[
        ...
        Section("Helmets", _slot_pred("head"),
                ...
                + ["Granite helm", "Serpentine helm (uncharged)",
                   ...
                   "Statius's full helm", "Torva full helm"],
...
RANGE = TabSpec(
    ...
    sections=[
        ...
        Section("Bows", _is_range_weapon_type("bow"),
                force_include=["Zaryte bow", "Zaryte bow (uncharged)"]),
...
SLAYER = TabSpec(
    ...
    sections=[
        Section("Slayer master items", _name_in({
            ...
            "Sanguine dust",
            # session 64 — Tombs of Amascut + Nex (Gielinor Games)
            "Ancient ceremonial top", "Ancient ceremonial legs",
            "Ancient ceremonial mask", "Ancient ceremonial gloves",
            "Ancient ceremonial boots",
            "Nihil shard", "Nihil dust", "Nihil horn", "Ancient hilt",
            "Frozen key",
            "Frozen key piece (armadyl)", "Frozen key piece (bandos)",
            "Frozen key piece (zamorak)", "Frozen key piece (saradomin)",
            # Cannon (or) ornaments (cross-tag with range Cannon section)
            "Cannon base (or)", "Cannon stand (or)",
            "Cannon barrels (or)", "Cannon furnace (or)",
        })),
    ...
    # Brief #53: explicit slayer-loadout overrides. With LLM cross-tags removed,
    # the items below would only appear in their primary tab (prayer pots in
    # prayer, sharks in cooking, cannonballs in range, etc.). The slayer tab is
    # explicitly a "ready-to-go on a slayer trip" loadout view, so we
    # force-add the consumables/utility a player wants visible there. Combat
    # GEAR (weapons/armour) is NOT included here — that stays in melee/range/
    # mage; slayer-specific gear (slayer helms, broad ammo, etc.) is already
    # primary=slayer via the LLM.
    # IDs sourced from tools/skillbank-data/out/llm-classifications.json;
    # LMS / minigame-locked variants deliberately excluded.
    extra_items=[
        # Combat potions (regular doses + divine variants)
        (12695, "Super combat potion(4)", "Slayer loadout"),
        (12697, "Super combat potion(3)", "Slayer loadout"),
        (12699, "Super combat potion(2)", "Slayer loadout"),
        (12701, "Super combat potion(1)", "Slayer loadout"),
        (23685, "Divine super combat potion(4)", "Slayer loadout"),
        (23688, "Divine super combat potion(3)", "Slayer loadout"),
        (23691, "Divine super combat potion(2)", "Slayer loadout"),
        (23694, "Divine super combat potion(1)", "Slayer loadout"),
        (2444, "Ranging potion(4)", "Slayer loadout"),
        (169, "Ranging potion(3)", "Slayer loadout"),
        (171, "Ranging potion(2)", "Slayer loadout"),
        (173, "Ranging potion(1)", "Slayer loadout"),
        (23733, "Divine ranging potion(4)", "Slayer loadout"),
        (23736, "Divine ranging potion(3)", "Slayer loadout"),
        (23739, "Divine ranging potion(2)", "Slayer loadout"),
        (23742, "Divine ranging potion(1)", "Slayer loadout"),
        (3040, "Magic potion(4)", "Slayer loadout"),
        (3042, "Magic potion(3)", "Slayer loadout"),
        (3044, "Magic potion(2)", "Slayer loadout"),
        (3046, "Magic potion(1)", "Slayer loadout"),
        (23745, "Divine magic potion(4)", "Slayer loadout"),
        (23748, "Divine magic potion(3)", "Slayer loadout"),
        (23751, "Divine magic potion(2)", "Slayer loadout"),
        (23754, "Divine magic potion(1)", "Slayer loadout"),
        (3024, "Super restore(4)", "Slayer loadout"),
        (3026, "Super restore(3)", "Slayer loadout"),
        (3028, "Super restore(2)", "Slayer loadout"),
        (3030, "Super restore(1)", "Slayer loadout"),
        (2434, "Prayer potion(4)", "Slayer loadout"),
        (139, "Prayer potion(3)", "Slayer loadout"),
        (141, "Prayer potion(2)", "Slayer loadout"),
        (143, "Prayer potion(1)", "Slayer loadout"),
        (6685, "Saradomin brew(4)", "Slayer loadout"),
        (6687, "Saradomin brew(3)", "Slayer loadout"),
        (6689, "Saradomin brew(2)", "Slayer loadout"),
        (6691, "Saradomin brew(1)", "Slayer loadout"),
        (10925, "Sanfew serum(4)", "Slayer loadout"),
        (10927, "Sanfew serum(3)", "Slayer loadout"),
        (10929, "Sanfew serum(2)", "Slayer loadout"),
        (10931, "Sanfew serum(1)", "Slayer loadout"),
        (22461, "Bastion potion(4)", "Slayer loadout"),
        (22464, "Bastion potion(3)", "Slayer loadout"),
        (22467, "Bastion potion(2)", "Slayer loadout"),
        (22470, "Bastion potion(1)", "Slayer loadout"),
        (24635, "Divine bastion potion(4)", "Slayer loadout"),
        (24638, "Divine bastion potion(3)", "Slayer loadout"),
        (24641, "Divine bastion potion(2)", "Slayer loadout"),
        (24644, "Divine bastion potion(1)", "Slayer loadout"),
        (22449, "Battlemage potion(4)", "Slayer loadout"),
        (22452, "Battlemage potion(3)", "Slayer loadout"),
        (22455, "Battlemage potion(2)", "Slayer loadout"),
        (22458, "Battlemage potion(1)", "Slayer loadout"),
        (24623, "Divine battlemage potion(4)", "Slayer loadout"),
        (24626, "Divine battlemage potion(3)", "Slayer loadout"),
        (24629, "Divine battlemage potion(2)", "Slayer loadout"),
        (24632, "Divine battlemage potion(1)", "Slayer loadout"),
        (2452, "Antifire potion(4)", "Slayer loadout"),
        (2454, "Antifire potion(3)", "Slayer loadout"),
        (2456, "Antifire potion(2)", "Slayer loadout"),
        (2458, "Antifire potion(1)", "Slayer loadout"),
        (11951, "Extended antifire(4)", "Slayer loadout"),
        (11953, "Extended antifire(3)", "Slayer loadout"),
        (11955, "Extended antifire(2)", "Slayer loadout"),
        (11957, "Extended antifire(1)", "Slayer loadout"),
        (21978, "Super antifire potion(4)", "Slayer loadout"),
        (21981, "Super antifire potion(3)", "Slayer loadout"),
        (21984, "Super antifire potion(2)", "Slayer loadout"),
        (21987, "Super antifire potion(1)", "Slayer loadout"),
        (22209, "Extended super antifire(4)", "Slayer loadout"),
        (22212, "Extended super antifire(3)", "Slayer loadout"),
        (22215, "Extended super antifire(2)", "Slayer loadout"),
        (22218, "Extended super antifire(1)", "Slayer loadout"),
        (5952, "Antidote++(4)", "Slayer loadout"),
        (5954, "Antidote++(3)", "Slayer loadout"),
        (5956, "Antidote++(2)", "Slayer loadout"),
        (5958, "Antidote++(1)", "Slayer loadout"),
        (12905, "Anti-venom(4)", "Slayer loadout"),
        (12907, "Anti-venom(3)", "Slayer loadout"),
        (12909, "Anti-venom(2)", "Slayer loadout"),
        (12911, "Anti-venom(1)", "Slayer loadout"),
        (12913, "Anti-venom+(4)", "Slayer loadout"),
        (12915, "Anti-venom+(3)", "Slayer loadout"),
        (12917, "Anti-venom+(2)", "Slayer loadout"),
        (12919, "Anti-venom+(1)", "Slayer loadout"),
        # Top food
        (385, "Shark", "Slayer loadout"),
        (391, "Manta ray", "Slayer loadout"),
        (13441, "Anglerfish", "Slayer loadout"),
        (3144, "Cooked karambwan", "Slayer loadout"),
        (3147, "Cooked karambwan", "Slayer loadout"),
        (11936, "Dark crab", "Slayer loadout"),
        (7060, "Tuna potato", "Slayer loadout"),
        # Teleports
        (8013, "Teleport to house", "Slayer loadout"),
        (19564, "Royal seed pod", "Slayer loadout"),
        (22400, "Drakan's medallion", "Slayer loadout"),
        # Utility — storage bags, bonecrushers, cannon, jewellery
        (12791, "Rune pouch", "Slayer loadout"),
        (13226, "Herb sack", "Slayer loadout"),
        (13639, "Seed box", "Slayer loadout"),
        (33384, "Gem pouch", "Slayer loadout"),
        (13116, "Bonecrusher", "Slayer loadout"),
        (22986, "Bonecrusher necklace", "Slayer loadout"),
        (25781, "Ash sanctifier", "Slayer loadout"),
        (6, "Cannon base", "Slayer loadout"),
        (8, "Cannon stand", "Slayer loadout"),
        (10, "Cannon barrels", "Slayer loadout"),
        (12, "Cannon furnace", "Slayer loadout"),
        (2, "Steel cannonball", "Slayer loadout"),
        (21728, "Granite cannonball", "Slayer loadout"),
        (20724, "Imbued heart", "Slayer loadout"),
        (27641, "Saturated heart", "Slayer loadout"),
        (2572, "Ring of wealth", "Slayer loadout"),
        (11988, "Ring of wealth (1)", "Slayer loadout"),
        (11986, "Ring of wealth (2)", "Slayer loadout"),
        (11984, "Ring of wealth (3)", "Slayer loadout"),
        (11980, "Ring of wealth (5)", "Slayer loadout"),
    ],
)
