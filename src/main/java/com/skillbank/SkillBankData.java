...
public final class SkillBankData
{
	...
	{
		// COOKING — 754 items
		//   Cooking tools & utensils (7), Raw fish (24), Raw meat (72), Cooked
		//   fish (432), Cooked meat (13), Fruits (20), Vegetables (15),
		//   Ingredients (20), Combo food (29), Baked & cooked goods (58), Burnt
		//   food (64)
	...
	{
		// HERBLORE — 675 items
		//   Herbs & tools (53), Secondaries (159), Unfinished potions (29),
		//   Finished potions (324), Barbarian mixes (52), Divine, extended &
		//   upgraded variants (58)
		m.put(TAG_HERBLORE, Arrays.asList(
			// === Herbs & tools ===
			3051, 3000, 261, 20908, 265, 267, 20800, 11877,
			11427, 11428, 20905, 211, 20907, 215, 217, 20904,
			199, 205, 30094, 209, 213, 2485, 201, 20901,
			207, 1533, 1525, 203, 3049, 219, 249, 255,
			30097, 259, 263, 2481, 251, 20902, 233, 257,
			1534, 1526, 253, 2998, 269, 229, 22446, 227,
	...
	private static void addHunter(Map<String, List<Integer>> m)
	{
		...
		//   (40), Creature products (184), Chinchompas (6), Implings & impling
		//   jars (14)
		m.put(TAG_HUNTER, Arrays.asList(
			...
			11519, 11517, 28831, 11262, 10028, 10027, 11258, 29166,
			10113, 10105, 10109, 10111, 29223, 29303, 29228, 29297,
			10107, 22201, 12744, 22195, 22192, 10143, 29301, 29292,
			29286, 29289, 29283, 29280, 8942, 29171, 29174, 28893,
			29213, 29195, 29240, 22832, 21515, 10091, 29231, 29256,
			10117, 29307, 28962, 10134, 31677, 29101, 9986, 9978,
			29107, 20874, 20870, 20878, 29113, 20880, 20876, 20872,
			20882, 29110, 3226, 2134, 29116, 29104, 31671, 10088,
			29234, 22204, 21126, 10020, 29204, 29186, 31261, 29238,
			10018, 29198, 29180, 28487, 303, 29299, 29295, 10016,
			29201, 29183, 9996, 9994, 10125, 10087, 10132, 29168,
			29177, 28890, 29210, 29192, 29237, 31635, 31632, 31629,
			31626, 29225, 1939, 29222, 10144, 29317, 21521, 10029,
			28834, 29259, 29261, 596, 21518, 10090, 22198, 10149,
			22816, 10023, 10156, 10158, 10159, 10146, 10075, 10147,
