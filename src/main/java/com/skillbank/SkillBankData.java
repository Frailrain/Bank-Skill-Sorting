...
public final class SkillBankData
{
	...
	private static void addMelee(Map<String, List<Integer>> m)
	{
		...
		m.put(TAG_MELEE, Arrays.asList(
			...
			1129, 1131, 2653, 2661, 2669, 2896, 2906, 2916,
			...
			1495, 1727, 2405, 2493, 2495, 2497, 2572, 5013,
			5680, 5698, 6215, 6217, 6227, 6313, 6315, 6317,
			6522, 6524, 6526, 6739, 8901, 8903, 8913, 9748,
			9751, 9754, 9769, 10356, 10358, 10360, 10446, 10450,
			10553, 11090, 11284, 11446, 11670, 11774, 11775, 11780,
			11798, 11799, 11800, 11810, 11814, 11816, 11818, 11820,
			11832, 11834, 11964, 11966, 12808, 12853, 13080, 13081,
			13082, 13083, 13084, 13085, 13086, 13087, 13088, 13089,
			13090, 13091, 13092, 13093, 13094, 13095, 13096, 13097,
			13098, 13099, 13100, 13101, 13241, 13280, 13317, 13318,
			19711, 20011, 20655, 20657, 20724, 22002, 22003, 22109,
			22545, 22616, 22638, 22956, 22975, 23673, 23764, 23989,
			24133, 24134, 24136, 24137, 24138, 24139, 24140, 24141,
			24142, 24143, 24157, 24158, 24160, 24161, 24169, 24170,
			24171, 24172, 24173, 24174, 24175, 24176, 24177, 24178,
			24179, 24180, 24182, 24183, 24184, 24185, 24186, 24194,
			24197, 24200, 24203, 24206, 24223, 24224, 24533, 24589,
			25173, 25176, 25177, 25643, 25975, 26376, 26384, 26386,
			26674, 26722, 26724, 26725, 26726, 26728, 26729, 26730,
			26732, 26734, 26736, 26752, 26754, 26756, 26758, 26760,
			27275, 27551, 27553, 28199, 28626, 30305, 32312, 32328,
			32336, 32344, 32352
		));
	}
	...
	private static void addPrayer(Map<String, List<Integer>> m)
	{
		...
		//   Quest-related prayer items (6), Prayer accessories (5), Legacy (50)
		m.put(TAG_PRAYER, Arrays.asList(
			...
			2967, 3839, 3847, 4850, 12601, 13202,

			// === Prayer accessories ===
			6714, 9759, 9761, 13116, 22986,

			// === Legacy carry-over (hand-curated items the new classifier missed) ===
			1704, 2408, 3843, 3845, 3846, 9760, 13447, 13450,
			13453, 13456, 13459, 13462, 13465, 13468, 13471, 13474,
			13477, 13480, 13483, 13486, 13489, 13492, 13495, 13498,
			13501, 13504, 13507, 13510, 18337, 19621, 19622, 19710,
			20264, 20266, 20268, 21047, 21643, 22111, 22374, 22378,
			22405, 22446, 22774, 24187, 25130, 25768, 25770, 25774,
			26996, 28323
		));
	}
	...
	private static void addCooking(Map<String, List<Integer>> m)
	{
		...
		//   cocktails (91), Beverages (11), Burnt food (65), Containers
		//   (water/milk/etc) (18), Raw meat & ingredients (104), Misc cooked food
		//   (32), Pies (extended) (19), Cooking pet & misc (4), Legacy (63)
		m.put(TAG_COOKING, Arrays.asList(
			...
			3328, 4293, 4297, 4299, 5980, 5982, 6701, 6703,
			6705, 6707, 6709, 6711, 6713, 7050, 7052, 7054,
			7056, 7058, 7060, 7062, 7064, 7174, 7190, 7210,
			7220, 7947, 9802, 9992, 11140, 22777, 24843, 24845,
			24847, 24849, 32312, 32328, 32336, 32344, 32352
		));
	}
	...
	{
		// AGILITY_THIEVING — 127 items
		//   Marks & tickets (3), Graceful set (7), Agility shortcut tools (3),
		//   Rogue equipment (6), Thieving accessories (9), Blackjacks (10),
		//   Pyramid plunder (1), Capes & pets (6), Legacy (82)
	...
	private static void addQuests(Map<String, List<Integer>> m)
	{
		...
		//   Diary - Wilderness (4), Diary - Morytania (4), Diary - Desert (4),
		//   Diary - Varrock (4), Diary - Western (4), Diary consumables (4), Quest
		//   unlock weapons (11), Quest cosmetic gear (13), Void Knight set (21),
