...
public final class SkillBankData
{
	...
	{
		// MELEE — 1480 items
		//   Combat utility (6), Weapons (289), Helmets (227), Body armour (139),
		//   Legs (126), Boots (73), Gloves (72), Shields (111), Capes (50),
		//   Amulets (37), Rings (17), Combat potions (56), Restores (cross-tag)
		//   (14), Combat food (23), Legacy (240)
		m.put(TAG_MELEE, Arrays.asList(
			...
			4513, 4551, 4567, 5014, 5574, 6128, 6131, 6137,
			6326, 7539, 7917, 9068, 9069, 9096, 9629, 9672,
			10039, 10045, 10051, 10334, 10350, 10374, 10382, 10390,
			10547, 10548, 10549, 10550, 10828, 11200, 11663, 11664,
			11665, 11864, 11865, 12466, 12486, 12496, 12504, 12637,
			12638, 12639, 12810, 12813, 12931, 13137, 13138, 13139,
			...
			3773, 3775, 3793, 4069, 4298, 5575, 6129, 6133,
			...
			3483, 3485, 3795, 4300, 5576, 6130, 6135, 6141,
			...
			11840, 19930, 1061, 3105, 3107, 3791, 4310, 6069,
			...
			4308, 6068, 6149, 6151, 6153, 6330, 7453, 7462,
			...
			5553, 5554, 5555, 5556, 5557, 5680, 5698, 6215,
	...
	private static void addRange(Map<String, List<Integer>> m)
	{
		...
		//   Cannon parts (cross-tag) (6), Ammunition (104), Bows (53), Crossbows
		//   (21), Thrown (41), D'hide armour (55), Raw dragonhide (cross-tag with
		//   crafting) (21), Helmets (27), Body (29), Legs (33), Boots (12), Gloves
		//   (32), Shields (15), Capes (76), Amulets (27), Rings (10), Ranging
		//   potions (8), Bait / feathers (cross-tag) (6), Combat food (cross-tag)
		//   (23), Legacy (210)
		m.put(TAG_RANGE, Arrays.asList(
			...
			// === Helmets ===
			23886, 23887, 23888, 23971, 4732, 2581, 10589, 11663,
			11664, 11665, 13359, 22326, 22625, 22638, 23840, 23841,
			23842, 26743, 26745, 26747, 27226, 27235, 27833, 27836,
			27847, 31172, 33247,

			// === Body ===
			23889, 23890, 23891, 23975, 25496, 4736, 26384, 28256,
			1133, 6322, 8839, 10564, 10822, 10954, 11832, 13072,
			22327, 22616, 22628, 22641, 23843, 23844, 23845, 27229,
			27238, 27831, 27834, 27837, 27848,

			// === Legs ===
			23892, 23893, 23894, 23979, 4738, 26386, 28258, 6324,
			6809, 8840, 10956, 11834, 13073, 13360, 13365, 13370,
			13375, 13380, 22328, 22619, 22631, 22644, 23846, 23847,
			23848, 26755, 26759, 27232, 27241, 27832, 27835, 27838,
			27849,

			// === Boots ===
			2577, 7159, 10958, 13237, 31088, 31091, 31092, 31093,
			31094, 31095, 31096, 31097,

			// === Gloves ===
			7454, 7455, 7456, 7457, 7458, 7459, 7460, 7461,
			7453, 7462, 8842, 11118, 11120, 11122, 11124, 11126,
			11133, 11136, 11138, 11140, 11972, 11974, 13103, 20041,
			26168, 26182, 26235, 26723, 26727, 27046, 30380, 30386,
			...
			5557, 6959, 9757, 9977, 10033, 10069, 10071, 10356,
			10358, 10360, 10362, 10364, 10366, 10446, 10450, 10498,
			10499, 11222, 11670, 11749, 11750, 11751, 11752, 11753,
			11754, 11755, 11756, 11757, 11758, 11760, 11761, 11762,
			11763, 11764, 11765, 11766, 11767, 11768, 11769, 11770,
			11826, 11828, 11830, 11864, 11865, 11959, 11964, 11966,
			12853, 12924, 13279, 13280, 13319, 19639, 19643, 20655,
			20657, 21264, 21330, 21557, 21888, 22246, 22247, 22248,
			22249, 22550, 23985, 24133, 24134, 24135, 24177, 24178,
			24179, 24180, 24182, 24183, 24184, 24185, 24222, 24223,
			24224, 24370, 24444, 25487, 25587, 25862, 25900, 26378,
			26380, 26724, 26725, 26726, 26728, 26729, 26730, 26744,
			26746, 26748, 26756, 26760, 27365, 27376, 27544, 27843,
			28906, 28957
		));
	}
	...
	private static void addMage(Map<String, List<Integer>> m)
	{
		// MAGE — 804 items
		//   Basic runes (16), Combo runes (6), Essence (4), Staves (115), Tomes
		//   (11), Helmets (84), Body (58), Legs (55), Boots (34), Gloves (60),
		...
		m.put(TAG_MAGE, Arrays.asList(
			...
			26751, 26753, 27238, 27837, 27840, 27848, 27851, 29013,
			29568, 30439,

			// === Legs ===
			23892, 23893, 23894, 25497, 4714, 30449, 11830, 12255,
			21024, 24668, 1033, 3389, 4093, 4103, 4113, 6141,
			6924, 7398, 8840, 9071, 9098, 10340, 10464, 10466,
			10468, 10838, 12195, 12267, 12421, 12459, 13073, 13389,
			20137, 20520, 22644, 22656, 23053, 23846, 23847, 23848,
			24294, 25401, 25416, 26245, 26755, 26757, 26759, 27241,
			27838, 27841, 27849, 27852, 29016, 29570, 30441,

			// === Boots ===
			19930, 2579, 3393, 4097, 4107, 4117, 6106, 6920,
			9073, 9100, 10552, 10839, 13132, 13235, 13237, 19921,
			19924, 19927, 19933, 19936, 20140, 22951, 23059, 25395,
			25410, 29806, 31088, 31091, 31092, 31093, 31094, 31095,
			31096, 31097,

			// === Gloves ===
			7454, 7455, 7456, 7457, 10085, 25494, 7458, 27110,
			7459, 7460, 27111, 7461, 12506, 777, 3391, 4095,
			4105, 4115, 6110, 6922, 7453, 7462, 9072, 9099,
			10083, 10336, 10368, 10376, 10384, 11118, 11120, 11122,
			11124, 11126, 11133, 11136, 11138, 11140, 11972, 11974,
			12490, 12498, 13103, 19544, 19994, 20041, 20134, 23056,
			25392, 25407, 26168, 26182, 26723, 26727, 27046, 27112,
			30082, 30380, 30386, 31106,
	...
	private static void addCooking(Map<String, List<Integer>> m)
	{
		...
		//   cocktails (91), Beverages (34), Burnt food (65), Containers
		...
		m.put(TAG_COOKING, Arrays.asList(
			...
			// === Beverages ===
			1911, 5745, 5809, 712, 1905, 1907, 1909, 1913,
			1915, 1917, 1919, 2955, 3711, 4627, 5504, 5739,
			5741, 5743, 5747, 5749, 5751, 5753, 5755, 5757,
			5759, 5761, 5763, 5765, 5767, 5769, 5777, 5785,
			5793, 5817,
