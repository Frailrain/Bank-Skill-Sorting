...
public final class SkillBankData
{
	...
	private static void addCooking(Map<String, List<Integer>> m)
	{
		...
		//   (37), Pies (extended) (19), Harvest produce (cross-tag with farming)
		//   (55), Cooking pet & misc (4), Legacy (58)
		m.put(TAG_COOKING, Arrays.asList(
			...
			6202, 6701, 6703, 6705, 6883, 7521, 7530, 7568,
			...
			7050, 7052, 7054, 7056, 7058, 7060, 7062, 7064,
			7174, 7190, 7210, 7220, 7947, 9802, 9992, 11140,
			22777, 24843, 24845, 24847, 24849, 32312, 32328, 32336,
			32344, 32352
		));
	}
