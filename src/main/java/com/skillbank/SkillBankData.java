...
public final class SkillBankData
{
	...
	private static void addCooking(Map<String, List<Integer>> m)
	{
		...
		//   (32), Pies (extended) (19), Harvest produce (cross-tag with farming)
		//   (44), Cooking pet & misc (4), Legacy (63)
	...
	{
		// FARMING — 288 items
		//   Tools (18), Compost (9), Seeds (158), Harvest produce (47), Farmer
		//   outfit (6), Cape & pet (3), Legacy (47)
		m.put(TAG_FARMING, Arrays.asList(
			...
			5377, 5504, 5955, 5972, 5978, 5982, 5984, 5986,
			6040, 6055, 9811, 11850, 11852, 11854, 11856, 11858,
			11860, 12623, 12625, 12627, 12629, 12631, 13138, 13226,
			13647, 13648, 13649, 13650, 14589, 22116, 22118, 22123,
			22586, 22997, 24840, 24842, 24856, 24858, 24860
		));
	}
