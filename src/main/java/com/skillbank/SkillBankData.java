...
public final class SkillBankData
{
	...
	private static void addMelee(Map<String, List<Integer>> m)
	{
		...
		//   Legs (124), Boots (68), Gloves (69), Shields (111), Capes (54),
	...
	private static void addRange(Map<String, List<Integer>> m)
	{
		...
		m.put(TAG_RANGE, Arrays.asList(
			...
			1133, 6133, 6322, 7362, 7364, 8839, 10564, 10822,
			...
			6324, 7366, 7368, 8840, 10956, 11834, 13073, 13360,
			13365, 13370, 13375, 13380, 22328, 22619, 22631, 22644,
			23846, 23847, 23848, 26755, 26759, 27232, 27241, 27832,
			27835, 27838, 27849,
	...
	private static void addMage(Map<String, List<Integer>> m)
	{
		// MAGE — 827 items
		//   Basic runes (16), Combo runes (6), Essence (4), Staves (115), Tomes
		//   (11), Helmets (86), Body (61), Legs (59), Boots (35), Gloves (59),
		//   Shields (28), Capes (80), Amulets (41), Rings (12), Magic potions
		//   (28), Orbs (cross-tag with crafting) (7), God cloaks (2), Spell
		//   tablets (POH lectern) (9), Combat food (cross-tag) (23), Legacy (145)
		m.put(TAG_MAGE, Arrays.asList(
			...
			10336, 10368, 10376, 10384, 11118, 11120, 11122, 11124,
			11126, 11133, 11136, 11138, 11140, 11972, 11974, 12490,
			12498, 13103, 19544, 19994, 20041, 20134, 23056, 25392,
			25407, 26168, 26182, 26723, 26727, 27046, 27112, 30082,
			30380, 30386, 31106,
			...
			9763, 10083, 10085, 10356, 10358, 10360, 10446, 10450,
			11090, 11670, 11791, 11864, 11964, 11966, 12791, 12853,
	...
	private static void addMiningSmithing(Map<String, List<Integer>> m)
	{
		...
		//   pickaxes (1), Smithing armour outputs (extended) (167), Gem
		//   cutting/polishing inputs (10), Legacy (49)
