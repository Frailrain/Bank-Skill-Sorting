...
public final class SkillBankData
{
	...
	{
		// MELEE — 1428 items
		//   Combat utility (6), Weapons (293), Godsword construction (11), Avernic
		...
		m.put(TAG_MELEE, Arrays.asList(
			...
			26482, 26233, 11804, 20370, 12774, 11806, 20372, 12773,
			11808, 20374, 23995, 24551, 28682, 21015, 22324, 25734,
			7142, 13263, 12006, 26484, 24880, 19675, 30955, 10129,
			10887, 27855, 11705, 31248, 24697, 5018, 11037, 7451,
			27021, 23823, 23820, 28531, 6746, 772, 28997, 23206,
			30957, 7435, 21003, 29589, 35, 33249, 3757, 7441,
			29889, 4153, 7141, 19941, 20756, 12357, 10581, 25979,
			30891, 25981, 27287, 27291, 7447, 7140, 7409, 11711,
			7449, 21649, 19918, 26219, 31049, 7445, 23528, 2402,
			7443, 30759, 7439, 7437, 24144, 22296, 11791, 29084,
			30388, 6523, 6525, 33036, 12902, 12904, 6527, 6528,
			23235, 27690, 29607, 2952, 7433,
	...
	private static void addRange(Map<String, List<Integer>> m)
	{
		...
		//   (35), Body (31), Legs (41), Boots (14), Gloves (41), Shields (15),
		//   Capes (76), Amulets (30), Rings (10), Ranging potions (12), Bait /
		//   feathers (cross-tag) (6), Combat food (cross-tag) (23), Legacy (8)
		m.put(TAG_RANGE, Arrays.asList(
			...
			// === Legacy carry-over (hand-curated items the new classifier missed) ===
			22616, 22619, 22625, 22628, 22631, 25585, 26384, 26386
		));
	}
	...
	private static void addMiningSmithing(Map<String, List<Integer>> m)
	{
		...
		//   (2), Smithing armour outputs (extended) (115), Gem cutting/polishing
		//   inputs (10), Legacy (34)
	...
	private static void addMisc(Map<String, List<Integer>> m)
	{
		...
		//   rares & cosmetics (253), Team capes (Castle Wars) (50), Currency (12)
