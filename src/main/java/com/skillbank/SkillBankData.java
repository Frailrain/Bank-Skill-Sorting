...
public final class SkillBankData
{
	...
	private static void addCrafting(Map<String, List<Integer>> m)
	{
		...
		m.put(TAG_CRAFTING, Arrays.asList(
			...
			1714, 28289, 28301, 571, 21518, 5933, 6045, 10891,
			13383, 10818, 1765, 22198, 6049
		));
	}
