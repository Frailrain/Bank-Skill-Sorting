...
public final class SkillBankData
{
	...
	private static void addCooking(Map<String, List<Integer>> m)
	{
		...
		//   cocktails (81), Beverages (11), Burnt food (65), Containers
		//   (water/milk/etc) (18), Raw meat & ingredients (105), Misc cooked food
		//   (32), Pies (extended) (19), Cooking pet & misc (4), Legacy (64)
		m.put(TAG_COOKING, Arrays.asList(
			...
			2199, 2205, 2209, 2213, 2217, 2219, 2221, 2223,
			2225, 2227, 2229, 2231, 2233, 2235, 2237, 2239,
			2241, 2243, 2253, 2255, 2259, 2277, 2281, 5004,
			6794,
			...
			2136, 2138, 2140, 2142, 2202, 2250, 2283, 2337,
			2876, 3226, 3228, 6178, 6200, 6697, 7168, 7176,
			7186, 7196, 7206, 7216, 7529, 7543, 7566, 7577,
			9978, 9986, 10087, 10816, 20855, 20857, 20859, 20861,
			20863, 20865, 20867, 20870, 20872, 20874, 20876, 20878,
			20880, 20882, 23872, 24782, 25564, 25652, 25658, 25664,
			25670, 25833, 29076, 29101, 29104, 29107, 29110, 29113,
			29116, 29119, 29122, 29125, 29216, 31553, 31561, 31686,
			31692, 31700, 32309, 32317, 32325, 32333, 32341, 32349,
			33106,
			...
			2184, 2287, 2880, 2881, 2883, 2884, 2885, 3151,
			3326, 3328, 4293, 4297, 4299, 5980, 5982, 6701,
			6703, 6705, 6707, 6709, 6711, 6713, 7050, 7052,
			7054, 7056, 7058, 7060, 7062, 7064, 7174, 7190,
			7210, 7220, 7947, 9802, 9992, 11140, 22777, 24843,
			24845, 24847, 24849, 32312, 32328, 32336, 32344, 32352
		));
	}
	...
	private static void addCrafting(Map<String, List<Integer>> m)
	{
		...
		//   D'hide (27), Glass (11), Misc crafting materials (3), Pottery (10),
	...
	{
		// HUNTER — 123 items
		//   Traps (5), Salamanders (10), Bait (7), Impling jars (12), Polar camo
		//   (2), Desert camo (2), Jungle camo (2), Larupia hunter (5), Graahk
		//   hunter (5), Kyatt hunter (5), Spotted/spottier (3), Cape & pet (4),
		//   Legacy (61)
