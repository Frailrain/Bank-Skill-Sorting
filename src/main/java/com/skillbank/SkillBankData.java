...
public final class SkillBankData
{
	...
	private static void addMelee(Map<String, List<Integer>> m)
	{
		...
		//   (221), Body armour (135), Legs (121), Boots (68), Gloves (69), Shields
		//   (112), Capes (54), Amulets (39), Rings (17), Combat potions (56),
		//   Restores (cross-tag) (14), Combat food (23), Legacy (264)
		m.put(TAG_MELEE, Arrays.asList(
			...
			30445, 12476, 12512, 21018, 24192, 24419, 24664, 26382,
			28254, 1167, 1169, 2657, 2665, 2673, 3327, 3329,
			3331, 3333, 3335, 3337, 3339, 3341, 3343, 3486,
			3748, 3749, 3751, 3753, 3755, 4071, 4302, 4513,
			4551, 4567, 5014, 5574, 6128, 7539, 7917, 9068,
			9069, 9096, 9629, 9672, 10039, 10045, 10051, 10334,
			10350, 10547, 10548, 10549, 10550, 10589, 10828, 11200,
			11663, 11664, 11665, 11864, 11865, 12466, 12486, 12496,
			12504, 12637, 12638, 12639, 12810, 12813, 12931, 13137,
			13138, 13139, 13140, 13197, 13199, 13359, 13364, 13369,
			...
			10053, 10057, 10061, 10065, 10348, 10551, 10564, 10822,
			11832, 12460, 12480, 12492, 12500, 12596, 12811, 12814,
			13072, 13104, 13105, 13106, 13107, 13361, 13366, 13371,
			13376, 13381, 19689, 20038, 20149, 20794, 20840, 21301,
			22653, 23097, 23264, 23787, 23843, 23844, 23845, 24037,
			25389, 25404, 26158, 26172, 26243, 26721, 26751, 26753,
			...
			10047, 10055, 10059, 10063, 10067, 10346, 10555, 10956,
			11834, 12462, 12464, 12482, 12484, 12494, 12502, 12812,
			...
			19691, 19994, 20041, 21736, 22981, 23091, 23261, 24046,
			25392, 25407, 26168, 26182, 26235, 26723, 26727, 27046,
			27112, 28630, 30380, 30386, 31106,
			...
			8913, 9748, 9751, 9754, 9769, 10330, 10332, 10356,
			10358, 10360, 10370, 10372, 10374, 10378, 10380, 10382,
			10386, 10388, 10390, 10446, 10450, 10553, 11090, 11284,
			11446, 11670, 11774, 11775, 11780, 11799, 11826, 11964,
	...
	private static void addRange(Map<String, List<Integer>> m)
	{
		...
		//   (33), Body (32), Legs (39), Boots (14), Gloves (38), Shields (15),
		//   Capes (77), Amulets (28), Rings (10), Ranging potions (12), Bait /
		//   feathers (cross-tag) (6), Combat food (cross-tag) (23), Legacy (212)
		m.put(TAG_RANGE, Arrays.asList(
			...
			// === Helmets ===
			23886, 23887, 23888, 23971, 4732, 11826, 2581, 6131,
			6326, 10334, 10374, 10382, 10390, 11663, 11664, 11665,
			13359, 22326, 22625, 22638, 23840, 23841, 23842, 26743,
			26745, 26747, 27226, 27235, 27833, 27836, 27847, 31172,
			33247,
			...
			// === Legs ===
			23892, 23893, 23894, 23979, 4738, 11830, 26386, 28258,
			6135, 6324, 7366, 7368, 8840, 10332, 10372, 10380,
			10388, 10956, 13073, 13360, 13365, 13370, 13375, 13380,
			22328, 22619, 22631, 22644, 23846, 23847, 23848, 26755,
			26759, 27232, 27241, 27832, 27835, 27838, 27849,
			...
			6149, 6330, 7453, 7462, 8842, 10336, 10368, 10376,
			10384, 11118, 11120, 11122, 11124, 11126, 11133, 11136,
			11138, 11140, 11972, 11974, 13103, 20041, 26168, 26182,
			26235, 26723, 26727, 27046, 30380, 30386,
			...
			5557, 6809, 6959, 9101, 9757, 9977, 10033, 10069,
			10071, 10356, 10358, 10360, 10364, 10366, 10446, 10450,
			10498, 10499, 10564, 10589, 11222, 11670, 11749, 11750,
			11751, 11752, 11753, 11754, 11755, 11756, 11757, 11758,
			11760, 11761, 11762, 11763, 11764, 11765, 11766, 11767,
			11768, 11769, 11770, 11832, 11834, 11864, 11865, 11959,
	...
	private static void addMage(Map<String, List<Integer>> m)
	{
		...
		//   shards (construction intermediates) (3), Tomes (11), Helmets (85),
		//   Body (59), Legs (58), Boots (35), Gloves (55), Shields (28), Capes
		//   (80), Amulets (43), Rings (12), Magic potions (28), Orbs (cross-tag
		//   with crafting) (7), God cloaks (2), Spell tablets (POH lectern) (9),
		//   Combat food (cross-tag) (23), Legacy (153)
		m.put(TAG_MAGE, Arrays.asList(
			...
			// === Helmets ===
			19641, 23886, 23887, 23888, 25495, 4708, 30445, 12259,
			21018, 24664, 579, 1017, 3385, 3755, 3797, 4089,
			4099, 4109, 6109, 6131, 6137, 6918, 7394, 7396,
			...
			// === Body ===
			581, 23889, 23890, 23891, 4712, 30447, 12253, 21021,
			24666, 577, 1035, 3387, 4091, 4101, 4111, 6107,
			6139, 6916, 7390, 7392, 7399, 8839, 9070, 9097,
			...
			// === Legs ===
			23892, 23893, 23894, 25497, 4714, 30449, 12255, 21024,
			24668, 1033, 3389, 4093, 4103, 4113, 6108, 6141,
			6924, 7386, 7388, 7398, 8840, 9071, 9098, 10340,
			...
			26759, 27168, 27241, 27838, 27841, 27849, 27852, 29016,
			29570, 30441,
			...
			// === Gloves ===
			7454, 7455, 7456, 7457, 25494, 7458, 27110, 7459,
			7460, 27111, 7461, 12506, 777, 3391, 4095, 4105,
			4115, 6110, 6153, 6922, 7453, 7462, 9072, 9099,
			11118, 11120, 11122, 11124, 11126, 11133, 11136, 11138,
			11140, 11972, 11974, 12490, 12498, 13103, 19544, 19994,
			20041, 20134, 23056, 25392, 25407, 26168, 26182, 26723,
			26727, 27046, 27112, 30082, 30380, 30386, 31106,
			...
			12201, 12269, 12851, 13393, 19707, 22111, 22557, 22986,
			24780, 29893, 30376,
			...
			9763, 10083, 10085, 10330, 10336, 10356, 10358, 10360,
			10368, 10376, 10384, 10446, 10450, 11090, 11670, 11791,
			11826, 11828, 11830, 11864, 11964, 11966, 12791, 12853,
			12899, 12900, 12902, 12904, 13102, 13280, 13392, 19639,
			19643, 20655, 20657, 20716, 20724, 21256, 21264, 21888,
			22288, 22323, 22370, 23727, 23730, 23916, 23959, 24133,
			24134, 24135, 24172, 24177, 24178, 24179, 24180, 24181,
			24183, 24184, 24185, 24222, 24223, 24224, 24232, 24233,
			24234, 24248, 24249, 24250, 24370, 24511, 25000, 25002,
			25006, 25009, 25011, 25024, 25026, 25030, 25033, 25035,
			25385, 25387, 25391, 25486, 25489, 25490, 25491, 25492,
			25576, 25731, 25987, 26724, 26725, 26726, 26728, 26729,
			26730, 26732, 26734, 26736, 26738, 26740, 26742, 26750,
			26752, 26754, 26756, 26758, 26760, 27275, 27281, 27365,
			27376, 27626, 28327, 28473, 28474, 28475, 28476, 29892,
			30066
		));
	}
	...
	{
		// FISHING — 114 items
		//   Rods & tools (15), Bait (8), Raw fish (25), Specialty fish (10),
	...
	private static void addMiningSmithing(Map<String, List<Integer>> m)
	{
		...
		//   Crystal-tool/Tier-fallback pickaxes (1), Smithing armour outputs
		//   (extended) (164), Gem cutting/polishing inputs (10), Legacy (50)
		m.put(TAG_MINING_SMITHING, Arrays.asList(
			...
			3488, 12460, 12462, 12464, 12466, 12468, 12480, 12482,
			12484, 12486, 12488, 12811, 12812, 12814, 12815, 20146,
			20149, 20152, 20794, 20796, 20840, 20842, 20844, 20846,
			21301, 21304, 22351, 22353, 22616, 22619, 22625, 22628,
			...
			10346, 10348, 10352, 10386, 10387, 10388, 10389, 10390,
			11941, 11942, 12019, 12797, 21343, 21345, 21390, 21539,
	...
	private static void addHerblore(Map<String, List<Integer>> m)
	{
		...
		//   poison (56), Energy & stamina (20), Other potions (60), Cape & pet
		//   (3), Legacy (37)
	...
	private static void addSlayer(Map<String, List<Integer>> m)
	{
		...
		m.put(TAG_SLAYER, Arrays.asList(
			...
			12436, 12899, 12922, 12924, 12926, 12927, 18337, 19550,
			19710, 19712, 21015, 21047, 21256, 21271, 21272, 21273,
			21285, 21295, 22006, 22104, 22345, 22461, 23490, 23491,
			24187, 24495, 24498, 24502, 24551, 24553, 25177, 25179,
			25181, 25183, 25185, 25187, 25189, 25191, 25731, 25902,
			25908, 25914, 26674, 26675, 26676, 26677, 26678, 26679,
			26680, 26681, 26682, 26683, 26684, 28626
		));
	}
	...
	{
		// FARMING — 329 items
		//   Tools (19), Compost (9), Seeds (158), Harvest produce (51), Farm
	...
	private static void addHunter(Map<String, List<Integer>> m)
	{
		...
		m.put(TAG_HUNTER, Arrays.asList(
			...
			9949, 9977, 9988, 10024, 10042, 10053, 10054, 10055,
			10056, 10066, 10068, 10073, 10087, 10088, 10089, 10090,
			10091, 10092, 10111, 13323, 13325, 13326, 13327, 21306,
			21337, 21338, 21339, 21344, 22446, 23783, 25821, 28247,
			28249, 28251, 28253
		));
	}
	...
	private static void addMisc(Map<String, List<Integer>> m)
	{
		...
		//   (79), Team capes (Castle Wars) (50), Currency (9), Legacy (72)
