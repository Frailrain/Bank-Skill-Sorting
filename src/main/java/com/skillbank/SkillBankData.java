...
public final class SkillBankData
{
	...
	private static void addPrayer(Map<String, List<Integer>> m)
	{
		// PRAYER — 338 items
		//   Bones (93), Ashes (9), Ensouled heads (23), Prayer potions (4), Super
		//   restores (10), Sanfew (4), Saradomin brews (4), Holy symbols (35),
		...
		m.put(TAG_PRAYER, Arrays.asList(
			...
			2963, 3840, 3842, 3844, 4817, 4829, 5508, 11640,
			12608, 12610, 12612, 13149, 13151, 13153, 13155, 13157,
			13159, 13513, 19515, 25818, 26488, 26490, 26492, 26494,
			26496, 26498, 29433,
			...
			9760, 13447, 13450, 13453, 13456, 13459, 13462, 13465,
			13468, 13471, 13474, 13477, 13480, 13483, 13486, 13489,
			13492, 13495, 13498, 13501, 13504, 13507, 13510, 18337,
			19621, 19622, 19710, 20264, 20266, 20268, 21047, 21643,
			22111, 22374, 22378, 22405, 22446, 22774, 24187, 25130,
			25768, 25770, 25774, 26996, 28323
		));
	}
	...
	private static void addSlayer(Map<String, List<Integer>> m)
	{
		// SLAYER — 171 items
		//   Slayer master items (4), Slayer rings (7), Slayer helmets (27), Black
		//   masks (18), Task-specific gear (26), Cannon (6), Cape & pet (4),
		//   Legacy (79)
		m.put(TAG_SLAYER, Arrays.asList(
			...
			4551, 7409, 7421, 7432, 8923, 13116, 13233, 21255,
			21724, 21736, 21739, 21742, 21752, 21754, 22951, 22983,
			22986, 23037,
	...
	private static void addMisc(Map<String, List<Integer>> m)
	{
		...
		//   (2), Holiday rares & cosmetics (16), Currency (7), Legacy (72)
		m.put(TAG_MISC, Arrays.asList(
			...
			// === Currency ===
			617, 1464, 4278, 6529, 13204, 13307, 29482,
