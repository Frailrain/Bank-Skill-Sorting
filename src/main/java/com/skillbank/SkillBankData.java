...
public final class SkillBankData
{
	...
	{
		// MELEE — 1480 items
		//   Combat utility (6), Weapons (289), Helmets (231), Body armour (141),
		//   Legs (128), Boots (74), Gloves (73), Shields (111), Capes (50),
		//   Amulets (37), Rings (17), Combat potions (56), Restores (cross-tag)
		//   (14), Combat food (23), Legacy (230)
		m.put(TAG_MELEE, Arrays.asList(
			...
			24419, 24664, 26382, 28254, 1167, 1169, 2657, 2665,
			2673, 3327, 3329, 3331, 3333, 3335, 3337, 3339,
			3341, 3343, 3486, 3748, 3749, 3751, 3753, 3755,
			4071, 4302, 4502, 4513, 4551, 4567, 5014, 5554,
			5574, 6128, 6131, 6137, 6326, 7539, 7917, 9068,
			9069, 9096, 9629, 9672, 10039, 10045, 10051, 10334,
			10350, 10374, 10382, 10390, 10547, 10548, 10549, 10550,
			10828, 11200, 11663, 11664, 11665, 11864, 11865, 12466,
			12486, 12496, 12504, 12637, 12638, 12639, 12810, 12813,
			12931, 13137, 13138, 13139, 13140, 13197, 13199, 13359,
			13364, 13369, 13374, 13379, 19643, 19645, 19647, 19649,
			19687, 19988, 20035, 20146, 20792, 20838, 21264, 21266,
			21298, 21838, 21888, 21890, 22650, 23073, 23075, 23101,
			23258, 23785, 23840, 23841, 23842, 24034, 24195, 24198,
			24201, 24204, 24271, 24370, 24444, 25165, 25398, 25413,
			25898, 25900, 25904, 25906, 25910, 25912, 26156, 26170,
			26241, 26731, 26733, 26735, 26743, 26745, 26747, 27042,
			27235, 27836, 27839, 27844, 27847, 27850, 28933, 29010,
			29019, 29028, 29816, 29818, 30073, 30111, 30321, 30437,
			30750, 30777, 31172, 33066, 33068, 33247, 33338,
			...
			1129, 1131, 2653, 2661, 2669, 3481, 3767, 3769,
			...
			24421, 24668, 1095, 2655, 2663, 2671, 3478, 3479,
			...
			11840, 19930, 1061, 3105, 3107, 3791, 4310, 5557,
			6069, 6143, 6145, 6147, 6328, 6666, 7159, 9005,
			9006, 9073, 9100, 9638, 9644, 10552, 10958, 11836,
			12391, 13129, 13130, 13131, 13132, 13237, 13239, 13358,
			13363, 13368, 13373, 13378, 19695, 19921, 19924, 19927,
			19933, 19936, 20047, 21643, 21733, 22951, 23037, 23093,
			23389, 24043, 25163, 25395, 25410, 25557, 28672, 28945,
			29286, 29806, 31088, 31091, 31092, 31093, 31094, 31095,
			31096, 31097,
			...
			3391, 3393, 5013, 5680, 5698, 6215, 6217, 6227,
			6313, 6315, 6317, 6522, 6524, 6526, 6739, 8901,
	...
	private static void addRange(Map<String, List<Integer>> m)
	{
		...
		//   Cannon parts (cross-tag) (6), Ammunition (104), Bows (53), Crossbows
		//   (21), Thrown (41), D'hide armour (55), Raw dragonhide (cross-tag with
		//   crafting) (21), Helmets (30), Body (32), Legs (36), Boots (13), Gloves
		...
		m.put(TAG_RANGE, Arrays.asList(
			...
			// === Helmets ===
			23886, 23887, 23888, 23971, 4716, 4724, 4745, 2581,
			5554, 10589, 11663, 11664, 11665, 13359, 22326, 22625,
			22638, 23840, 23841, 23842, 26743, 26745, 26747, 27226,
			27235, 27833, 27836, 27847, 31172, 33247,
			...
			// === Boots ===
			2577, 5557, 7159, 10958, 13237, 31088, 31091, 31092,
	...
	private static void addMage(Map<String, List<Integer>> m)
	{
		// MAGE — 804 items
		//   Basic runes (16), Combo runes (6), Essence (4), Staves (115), Tomes
		//   (11), Helmets (85), Body (60), Legs (57), Boots (35), Gloves (61),
		//   Shields (28), Capes (77), Amulets (41), Rings (12), Magic potions
		//   (28), Orbs (cross-tag with crafting) (7), God cloaks (2), Combat food
		//   (cross-tag) (23), Legacy (136)
		m.put(TAG_MAGE, Arrays.asList(
			...
			4089, 4099, 4109, 5554, 6109, 6131, 6137, 6918,
			7400, 9068, 9069, 9096, 9729, 9733, 10342, 10452,
			10454, 10456, 10547, 10836, 11663, 11664, 11665, 11865,
			12203, 12271, 12419, 12457, 13385, 19645, 19649, 20128,
			20595, 21266, 21890, 22638, 22650, 23047, 23075, 23522,
			23840, 23841, 23842, 24288, 24444, 25398, 25413, 25900,
			25906, 25912, 26241, 26731, 26733, 26735, 26737, 26739,
			26741, 27226, 27235, 27839, 27850, 29019, 29566, 29818,
			30111, 30437, 31172, 33068, 33247,
			...
			2930, 2940, 6099, 6215, 6217, 6227, 7640, 7645,
			8842, 9763, 10356, 10358, 10360, 10446, 10450, 11090,
			11670, 11791, 11864, 11964, 11966, 12791, 12853, 12899,
			12900, 12902, 12904, 13102, 13280, 13392, 19639, 19643,
			20655, 20657, 20716, 20724, 21256, 21264, 21888, 22288,
			22323, 22370, 23727, 23730, 23916, 23959, 24133, 24134,
			24135, 24172, 24177, 24178, 24179, 24180, 24181, 24183,
			24184, 24185, 24222, 24223, 24224, 24232, 24233, 24234,
			24248, 24249, 24250, 24370, 24511, 25000, 25002, 25006,
			25009, 25011, 25024, 25026, 25030, 25033, 25035, 25385,
			25387, 25391, 25486, 25489, 25490, 25491, 25492, 25576,
			25731, 25987, 26724, 26725, 26726, 26728, 26729, 26730,
			26732, 26734, 26736, 26738, 26740, 26742, 26750, 26752,
			26754, 26756, 26758, 26760, 27275, 27281, 27365, 27376,
			27626, 28327, 28473, 28474, 28475, 28476, 29892, 30066
		));
	}
	...
	private static void addCrafting(Map<String, List<Integer>> m)
	{
		...
		//   D'hide (27), Glass (11), Misc crafting materials (5), Pottery (10),
	...
	private static void addMiningSmithing(Map<String, List<Integer>> m)
	{
		...
		//   Pickaxes (18), Mining tools & bags (6), Ores (19), Bars (10), Smithing
		//   outputs (8), Mining outfit (Prospector) (4), Mining/Smithing capes &
		//   pets (5), Crystal-tool/Tier-fallback pickaxes (1), Smithing armour
		//   outputs (extended) (167), Gem cutting/polishing inputs (10), Legacy
		//   (49)
	...
	private static void addHerblore(Map<String, List<Integer>> m)
	{
		...
		//   (32), Unfinished potions (22), Attack potions (8), Strength potions
		//   (8), Defence potions (8), Super attack/strength/defence (12), Super
