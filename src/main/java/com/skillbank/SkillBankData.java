...
public final class SkillBankData
{
	...
	{
		// FLETCHING — 269 items
		//   Tools (4), Materials (147), Shortbows (12), Longbows (13), Crossbow
		//   stocks (8), Crossbows (17), Finished arrows (15), Finished bolts (34),
		//   Finished darts (10), Finished javelins (9)
		m.put(TAG_FLETCHING, Arrays.asList(
			// === Tools ===
			31043, 946, 9783, 9785,

			// === Materials ===
			39, 9375, 819, 19570, 9420, 4819, 40, 9377,
			820, 19572, 9423, 4820, 31579, 41, 9378, 821,
			19574, 9425, 1539, 4821, 42, 9379, 822, 19576,
			9427, 4822, 43, 9380, 823, 19578, 9429, 4823,
			44, 824, 19580, 4824, 11237, 21930, 11232, 19582,
			21918, 22795, 1615, 9193, 2862, 21347, 21350, 21338,
			25853, 21352, 52, 31004, 30998, 31045, 19592, 19601,
			47, 10089, 9376, 9422, 1777, 31052, 11885, 11874,
			31086, 20696, 20695, 31575, 22935, 1755, 9438, 1601,
			9192, 31047, 29415, 1605, 9190, 31032, 31018, 314,
			11881, 31024, 31027, 19589, 29311, 29305, 19598, 19595,
			1611, 9187, 19584, 10105, 19586, 1511, 2511, 10107,
			1513, 1517, 9418, 9416, 19610, 29171, 1521, 2864,
			6573, 9194, 1609, 45, 10091, 411, 413, 46,
			10088, 1613, 31049, 31583, 1603, 9191, 9381, 9431,
			1607, 9189, 8934, 28798, 26030, 9382, 31572, 10087,
			29168, 12922, 9188, 29580, 11887, 19607, 19604, 31054,
			1519, 2859, 2861, 10090, 1515, 22251, 22254, 22263,
			22257, 22266, 22260,

			// === Shortbows ===
			72, 64, 54, 50, 60, 68, 841, 843,
			849, 853, 857, 861,

			// === Longbows ===
			48, 70, 62, 56, 4825, 58, 66, 839,
			845, 847, 851, 855, 859,
			...
			890, 892, 11212, 2865, 53, 21326, 4160,

			// === Finished bolts ===
			877, 9140, 9141, 9142, 9143, 9341, 21969, 21905,
			21971, 21965, 21957, 21973, 21955, 21959, 21967, 21963,
			21961, 28878, 28872, 11876, 9139, 9335, 9145, 9336,
			9337, 9338, 9339, 10158, 10159, 11875, 9340, 9342,
			9144, 21316,

			// === Finished darts ===
			806, 807, 808, 809, 810, 811, 11230, 25849,
			28991, 31010,

			// === Finished javelins ===
			825, 826, 827, 828, 829, 830, 19484, 23648,
			21318
		));
	}
