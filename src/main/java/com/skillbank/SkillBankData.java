...
public final class SkillBankData
{
	...
	{
		// MELEE — 1491 items
		//   Combat utility (6), Weapons (285), Helmets (222), Body armour (134),
		//   Legs (120), Boots (68), Gloves (69), Shields (112), Capes (54),
		//   Amulets (39), Rings (17), Combat potions (56), Restores (cross-tag)
		//   (14), Combat food (23), Legacy (272)
		m.put(TAG_MELEE, Arrays.asList(
			...
			10334, 10350, 10547, 10548, 10549, 10550, 10589, 10828,
	...
	private static void addRange(Map<String, List<Integer>> m)
	{
		...
		//   Cannon parts (cross-tag) (6), Ammunition (104), Bows (53), Crossbows
		//   (21), Thrown (41), D'hide armour (55), Raw dragonhide (cross-tag with
		//   crafting) (21), Helmets (32), Body (32), Legs (39), Boots (14), Gloves
		...
		m.put(TAG_RANGE, Arrays.asList(
			...
			10334, 10374, 10382, 10390, 11663, 11664, 11665, 13359,
			22326, 22625, 22638, 23840, 23841, 23842, 26743, 26745,
			26747, 27226, 27235, 27833, 27836, 27847, 31172, 33247,
			...
			6324, 7366, 7368, 8840, 10332, 10372, 10380, 10388,
			10956, 11834, 13073, 13360, 13365, 13370, 13375, 13380,
	...
	private static void addMage(Map<String, List<Integer>> m)
	{
		// MAGE — 829 items
		//   Basic runes (16), Combo runes (6), Essence (4), Staves (115), Tomes
		//   (11), Helmets (86), Body (60), Legs (59), Boots (35), Gloves (55),
		//   Shields (28), Capes (80), Amulets (43), Rings (12), Magic potions
		//   (28), Orbs (cross-tag with crafting) (7), God cloaks (2), Spell
		//   tablets (POH lectern) (9), Combat food (cross-tag) (23), Legacy (150)
		m.put(TAG_MAGE, Arrays.asList(
			...
			4089, 4099, 4109, 6109, 6131, 6137, 6918, 7394,
			7396, 7400, 9068, 9069, 9096, 9729, 9733, 10342,
			10452, 10454, 10456, 10547, 10836, 11663, 11664, 11665,
			11865, 12203, 12271, 12419, 12457, 13385, 19645, 19649,
			20128, 20595, 21266, 21890, 22638, 22650, 23047, 23075,
			...
			6107, 6139, 6916, 7390, 7392, 7399, 8839, 9070,
			9097, 10338, 10458, 10460, 10462, 10837, 12193, 12265,
			...
			6141, 6924, 7386, 7388, 7398, 8840, 9071, 9098,
			10340, 10464, 10466, 10468, 10838, 12195, 12267, 12421,
			12459, 13073, 13389, 20137, 20520, 22644, 22656, 23053,
	...
	private static void addHerblore(Map<String, List<Integer>> m)
	{
		...
		//   (20), Other potions (60), Cape & pet (3), Legacy (37)
