...
public final class SkillBankData
{
	...
	private static void addMelee(Map<String, List<Integer>> m)
	{
		...
		//   Legs (134), Boots (81), Gloves (79), Shields (110), Capes (50),
		//   Amulets (37), Rings (17), Combat potions (56), Restores (cross-tag)
		//   (14), Combat food (23), Legacy (202)
		m.put(TAG_MELEE, Arrays.asList(
			...
			7459, 7460, 27111, 7461, 1059, 1580, 2902, 2912,
			2922, 2932, 2942, 2997, 3391, 3799, 4308, 5556,
			6068, 6149, 6151, 6153, 6330, 7453, 7462, 7537,
			8842, 8929, 9072, 9099, 10075, 10077, 10079, 10081,
			10083, 11118, 11120, 11122, 11124, 11126, 11133, 11136,
			11138, 11140, 11972, 11974, 13103, 13357, 13362, 13367,
			13372, 13377, 19691, 19994, 20041, 21736, 22981, 23091,
			23261, 24046, 25392, 25407, 26168, 26182, 26235, 26723,
			26727, 27046, 27112, 28630, 30380, 30386, 31106,
			...
			1495, 1727, 2493, 2495, 2497, 2572, 5013, 5680,
			5698, 6215, 6217, 6227, 6313, 6315, 6317, 6522,
			6524, 6526, 6739, 8901, 8903, 8913, 9748, 9751,
			9754, 9769, 10356, 10358, 10360, 10446, 10450, 10553,
			11090, 11284, 11446, 11670, 11774, 11775, 11780, 11798,
			11799, 11800, 11810, 11814, 11816, 11818, 11820, 11832,
			11834, 11964, 11966, 12808, 12853, 13080, 13081, 13082,
			13083, 13084, 13085, 13086, 13087, 13088, 13089, 13090,
			13091, 13092, 13093, 13094, 13095, 13096, 13097, 13098,
			13099, 13100, 13101, 13241, 13280, 13317, 13318, 19711,
			20011, 20655, 20657, 20724, 22002, 22003, 22109, 22545,
			22616, 22638, 22956, 22975, 23673, 23764, 23989, 24133,
			24134, 24136, 24137, 24138, 24139, 24140, 24141, 24142,
			24143, 24157, 24158, 24160, 24161, 24169, 24170, 24171,
			24172, 24173, 24174, 24175, 24176, 24177, 24178, 24179,
			24180, 24182, 24183, 24184, 24185, 24186, 24194, 24197,
			24200, 24203, 24206, 24223, 24224, 24533, 24589, 25173,
			25176, 25177, 25643, 25975, 26376, 26384, 26386, 26674,
			26722, 26724, 26725, 26726, 26728, 26729, 26730, 26732,
			26734, 26736, 26752, 26754, 26756, 26758, 26760, 27275,
			27551, 27553, 28199, 28626, 30305, 32312, 32328, 32336,
			32344, 32352
		));
	}
	...
	private static void addMisc(Map<String, List<Integer>> m)
	{
		...
		m.put(TAG_MISC, Arrays.asList(
			...
			// === Currency ===
			617, 1464, 6529, 13204, 13307, 29482,
