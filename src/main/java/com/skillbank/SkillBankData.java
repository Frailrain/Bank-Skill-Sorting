...
public final class SkillBankData
{
	...
	{
		// MELEE — 1488 items
		//   Combat utility (6), Weapons (285), Helmets (221), Body armour (133),
		...
		m.put(TAG_MELEE, Arrays.asList(
			...
			10334, 10350, 10547, 10548, 10549, 10550, 10828, 11200,
			...
			10053, 10057, 10061, 10065, 10348, 10551, 10822, 12460,
	...
	private static void addRange(Map<String, List<Integer>> m)
	{
		...
		//   Cannon parts (cross-tag) (6), Ammunition (104), Bows (53), Crossbows
		//   (21), Thrown (41), D'hide armour (55), Raw dragonhide (cross-tag with
		//   crafting) (21), Helmets (33), Body (33), Legs (39), Boots (14), Gloves
		...
		m.put(TAG_RANGE, Arrays.asList(
			...
			10334, 10374, 10382, 10390, 10589, 11663, 11664, 11665,
			...
			1133, 6133, 6322, 7362, 7364, 8839, 10330, 10564,
			10822, 10954, 11832, 13072, 22327, 22616, 22628, 22641,
	...
	{
		// FARMING — 325 items
		//   Tools (19), Compost (9), Seeds (158), Harvest produce (47), Farm
	...
	private static void addMisc(Map<String, List<Integer>> m)
	{
		...
		//   (2), Holiday rares & cosmetics (68), Team capes (Castle Wars) (50),
